...
class CompletePurchaseRequestTest extends TestCase
{
    ...
    public function getItnPostData()
    {
        return array(
            ...
            'name_first' => 'Test',
            'name_last' => 'User 01',
            'email_address' => 'sbtu01@paynow.co.zw',
    ...
    public function testCompletePurchaseItnSuccess()
    {
        ...
        $this->assertInstanceOf('Omnipay\PayNow\Message\CompletePurchaseItnResponse', $response);
    ...
    public function testCompletePurchasePdtSuccess()
    {
        ...
        $this->assertInstanceOf('Omnipay\PayNow\Message\CompletePurchasePdtResponse', $response);
        $this->assertFalse($response->isSuccessful());
        $this->assertFalse($response->isRedirect());
        $this->assertNull($response->getTransactionReference());
